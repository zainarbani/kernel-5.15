...
// Note: v0.3
// - 2020.12, Refactoring
// - 2021.12, Add CONFIG_HW_RANDOM_S2Q000_DIAG_TIMEOUT_LIMIT
// ---------------------------------------------------------------------------
...
#define	DIAG_TIMEOUT_MS		CONFIG_HW_RANDOM_S2Q000_DIAG_TIMEOUT_LIMIT // default 2000
...
static int qrng_diag(void)
{
	...
	for (i=0, p=kbuf; i<DIAG_READ_CNT; i++, p+=DIAG_READ_SIZE)
	{
		...
		if (DIAG_TIMEOUT_MS > 0 && elps_ms > DIAG_TIMEOUT_MS)
		{
